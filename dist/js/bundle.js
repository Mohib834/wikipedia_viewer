...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _model_Search__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./model/Search */ \"./src/js/model/Search.js\");\n/* harmony import */ var _view_base__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./view/base */ \"./src/js/view/base.js\");\n/* harmony import */ var _view_viewSearch__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./view/viewSearch */ \"./src/js/view/viewSearch.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\nvar main = __webpack_require__(/*! ../styles/style.scss */ \"./src/styles/style.scss\");\n\nvar loader = __webpack_require__(/*! ../styles/loading.scss */ \"./src/styles/loading.scss\"); // const bannerImg = require('../img/banner.jpeg');\n\n\n\n\n\nvar state = {};\n\nvar controllerSearch =\n/*#__PURE__*/\nfunction () {\n  var _ref = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee() {\n    var query;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            //1) Get the value from input\n            query = _view_viewSearch__WEBPACK_IMPORTED_MODULE_2__[\"getQuery\"]();\n\n            if (!query) {\n              _context.next = 11;\n              break;\n            }\n\n            //2) Make a new Search Obj with query and fetch Data\n            state.search = new _model_Search__WEBPACK_IMPORTED_MODULE_0__[\"default\"](query); //3) Prepare Ui for Result\n            //clear input value\n\n            _view_viewSearch__WEBPACK_IMPORTED_MODULE_2__[\"clearQuery\"](); //Shift Search bar up top\n\n            _view_viewSearch__WEBPACK_IMPORTED_MODULE_2__[\"moveToTop\"](); //Clear Existing results\n\n            _view_viewSearch__WEBPACK_IMPORTED_MODULE_2__[\"clearResult\"](); //Render Loader\n\n            Object(_view_base__WEBPACK_IMPORTED_MODULE_1__[\"renderLoader\"])(); //4) Search the Query\n\n            _context.next = 9;\n            return state.search.getData();\n\n          case 9:\n            //5) Render Result on UI\n            Object(_view_base__WEBPACK_IMPORTED_MODULE_1__[\"clearLoader\"])();\n            _view_viewSearch__WEBPACK_IMPORTED_MODULE_2__[\"renderResult\"](state.search.result);\n\n          case 11:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee);\n  }));\n\n  return function controllerSearch() {\n    return _ref.apply(this, arguments);\n  };\n}();\n\n_view_base__WEBPACK_IMPORTED_MODULE_1__[\"elements\"].search.addEventListener('keypress', function (e) {\n  if (e.which === 13) {\n    controllerSearch();\n  }\n});\nwindow.addEventListener('click', function (e) {\n  var btn = e.target.closest('.btn');\n\n  if (btn) {\n    var gotoPage = parseInt(btn.dataset.goto, 10);\n    _view_viewSearch__WEBPACK_IMPORTED_MODULE_2__[\"clearResult\"]();\n    window.scrollTo(0, 0);\n    _view_viewSearch__WEBPACK_IMPORTED_MODULE_2__[\"renderResult\"](state.search.result, gotoPage);\n  }\n});\n\n//# sourceURL=webpack:///./src/js/index.js?");
...
/*!***********************************!*\
  !*** ./src/js/view/viewSearch.js ***!
  \***********************************/
/*! exports provided: getQuery, clearQuery, moveToTop, clearResult, renderResult */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getQuery\", function() { return getQuery; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"clearQuery\", function() { return clearQuery; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"moveToTop\", function() { return moveToTop; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"clearResult\", function() { return clearResult; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"renderResult\", function() { return renderResult; });\n/* harmony import */ var _base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./base */ \"./src/js/view/base.js\");\n\nvar getQuery = function getQuery() {\n  return _base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].search.value;\n};\nvar clearQuery = function clearQuery() {\n  return _base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].search.value = '';\n};\nvar moveToTop = function moveToTop() {\n  return _base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].searchBox.classList.add('moveUp');\n};\nvar clearResult = function clearResult() {\n  _base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].result.innerHTML = '';\n  _base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].pagination.innerHTML = '';\n};\n\nvar renderResultUI = function renderResultUI(e) {\n  var markup = \"\\n        <li class=\\\"result-item\\\">\\n            <a href=\\\"https://en.wikipedia.org/wiki/\".concat(e.title, \"\\\" target=\\\"_blank\\\">\\n                <h3>#\").concat(e.title, \"</h3>\\n                <p>\").concat(e.snippet, \"</p>\\n            </a>\\n        </li>\\n    \");\n  _base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].result.insertAdjacentHTML('beforeend', markup);\n};\n\nvar createBtn = function createBtn(type, page) {\n  return \"\\n        <div class=\\\"btn btn--\".concat(type, \"\\\" data-goto=\\\"\").concat(type === 'prev' ? page - 1 : page + 1, \"\\\">\\n               \").concat(type.charAt(0).toUpperCase() + type.slice(1), \"\\n        </div>\\n    \");\n};\n\nvar renderPaginationBtn = function renderPaginationBtn(page, numResult, resPerPage) {\n  var pages = Math.ceil(numResult / resPerPage);\n  var btn;\n\n  if (page === 1 && pages > 1) {\n    //Create Next Btn on UI\n    btn = createBtn('next', page);\n  } else if (page < pages) {\n    //Create Both Next and Prev Btn on UI\n    btn = \"\\n            \".concat(createBtn('prev', page), \"\\n            \").concat(createBtn('next', page), \"\\n        \");\n  } else if (page === pages && pages > 1) {\n    //Create Prev Btn on UI\n    btn = createBtn('prev', page);\n  }\n\n  _base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].pagination.insertAdjacentHTML('afterbegin', btn);\n};\n\nvar renderResult = function renderResult(resultArr) {\n  var page = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;\n  var resPerPage = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 10;\n  //pagination\n  var start = (page - 1) * resPerPage;\n  var end = page * resPerPage; //slicing result and then rendering it on ui\n\n  resultArr.slice(start, end).forEach(function (el) {\n    return renderResultUI(el);\n  });\n  renderPaginationBtn(page, resultArr.length, resPerPage);\n};\n\n//# sourceURL=webpack:///./src/js/view/viewSearch.js?");
...
eval("// extracted by mini-css-extract-plugin\n\n//# sourceURL=webpack:///./src/styles/loading.scss?");
